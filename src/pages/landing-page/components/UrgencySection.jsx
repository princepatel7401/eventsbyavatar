...
const UrgencySection = () => {
  ...
  useEffect(() => {
    const slotTimer = setInterval(() => {
      if (Math.random() < 0.1 && consultationSlots > 2) { // 10% chance every 30 seconds
  ...
  const getSeasonalMessage = () => {
    ...
    if (month >= 9 && month <= 2) { // Oct-Feb (Wedding season in India)
      return {
    ...
    } else if (month >= 3 && month <= 5) { // Mar-May (Corporate events)
      return {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="flex items-center justify-center mb-4">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-white">{consultationSlots}</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="text-center mb-4">
                <Icon name="Timer" size={32} className="text-accent mx-auto mb-2" />
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 mb-8">
            <div className="flex items-center justify-center mb-4">
              <Icon name="Gift" size={24} className="text-accent mr-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              ...
              <div className="flex items-center">
                <Icon name="Check" size={16} className="text-accent mr-2 flex-shrink-0" />
                <span className="text-white/90 text-sm">Free premium vendor consultations</span>
              </div>
              <div className="flex items-center">
                <Icon name="Check" size={16} className="text-accent mr-2 flex-shrink-0" />
                <span className="text-white/90 text-sm">Priority booking privileges</span>
              </div>
              <div className="flex items-center">
                <Icon name="Check" size={16} className="text-accent mr-2 flex-shrink-0" />
                <span className="text-white/90 text-sm">Extended planning timeline</span>
              </div>
            </div>
          </div>
